...
export function WorkListSummaryChip({
  ...
  return (
    <span
      className={
        compact
          ? 'inline-flex h-7 max-w-full items-center gap-2 rounded-sm border border-gray-200 bg-white px-2 text-xs text-gray-700 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300'
          : 'inline-flex h-7 max-w-full items-center gap-2 rounded-sm border border-gray-200 bg-white px-2 text-xs text-gray-700 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300'
      }
    >
      <span
